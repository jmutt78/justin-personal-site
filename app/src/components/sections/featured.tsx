...
const Featured = () => {
  ...
  useEffect(() => {
    ...
    revealProjects.current
      .filter((ref) => ref !== null)
      .forEach((ref, i) => sr?.reveal(ref as HTMLElement, srConfig(i * 100)));
  }, []);
      ...
      <StyledProjectsGrid>
        {featuredProjects &&
          featuredProjects.map(({ node }: any, i: React.Key | null | undefined) => {
            ...
            return (
              <StyledProject key={i} ref={(el) => revealProjects.current.push(el)}>
                  ...
                  <div>
                    ...
                    {tech.length && (
                      <ul className='project-tech-list'>
                        {tech.map((tech: React.ReactFragment, i: React.Key | null | undefined) => (
                          <li key={i}>{tech}</li>
                        ))}
                      </ul>
                    )}
